...
if ~isempty(hToolbar)
	...
	old_ToolHandles  =     cat(1,Rot3D, ZoomO, ZoomI,WL,PZ,RT,MV,PM,RotT);
	old_ToolEnables  = get(cat(1,Rot3D, ZoomO, ZoomI,WL,PZ,RT,MV,PM,RotT), 'Enable');
	old_ToolStates   = get(cat(1,Rot3D, ZoomO, ZoomI,WL,PZ,RT,MV,PM,RotT), 'State');
