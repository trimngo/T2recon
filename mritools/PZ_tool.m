...
if ~isempty(hToolbar)
	...
	old_ToolHandles  =     cat(1,Rot3D, ZoomO, ZoomI,WL,RT,MV,PM, RotT,Prof);
	old_ToolEnables  = get(cat(1,Rot3D, ZoomO, ZoomI,WL,RT,MV,PM, RotT,Prof), 'Enable');
	old_ToolStates   = get(cat(1,Rot3D, ZoomO, ZoomI,WL,RT,MV,PM, RotT,Prof), 'State');
